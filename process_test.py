...
if __name__ == "__main__":
    # Print console output header line
    print("        CO2 CAPTURE PROCESS TEST      ")

    # Run complete process simulation with standard test arguments
    results = simulate_process(
        co2_inlet_fraction=0.12,
        gas_flow=10.0,
        solvent_flow=1.0,
        mea_mass_fraction=0.30,
        absorber_temperature_K=313.15,
        pressure_Pa=101325.0,
        column_height=10.0,
        column_area=1.0,
        mass_transfer_coefficient=0.1,
        regeneration_temperature_K=393.15,
        feed_temperature_K=313.15,
        initial_loading=0.20
    )

    # Print results summary section divider
    ...
    print(f"Specific energy:         {results['specific_energy_GJ_per_tonne_CO2'] * 1000:.4f} J/kg CO2")
